...
package com.hec.bluetooth.Service;
...
import com.hec.bluetooth.Activity.MainActivity;
...
public class BluetoothChatService {
    ...
    private static final String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/bluetoothBluetooth/";
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    sendMessageToUi(MainActivity.BLUE_TOOTH_TOAST, "Device connection failed / Transport closed");
            ...
            executorService.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Log.i("hec Bluetooth message transmission", "\n" +
                                "Failed to send");
                    }
    ...
    class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            Log.e(TAG, "run: connectThread connected, ready to transmit");
