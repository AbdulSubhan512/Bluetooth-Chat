...
import com.hec.bluetooth.Adapter.ViewPagerAdapter;
import com.hec.bluetooth.Fragment.HomeFragment;
import com.hec.bluetooth.Fragment.SettingFragment;
        ...
        XPermissionUtil.requestPermissions(this, 1,
                ...
                new XPermissionUtil.OnPermissionListener() {
                    ...
                    public void onPermissionDenied() {
                        Snackbar.make(bottomNavigationView, "Please go to the settings to give relevant permissions", Snackbar.LENGTH_LONG).show();
                    }
                });
    }
