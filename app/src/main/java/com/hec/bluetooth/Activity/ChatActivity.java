package com.hec.bluetooth.Activity;

import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_READ;
import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_READ_FILE;
import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_READ_FILE_NOW;
import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_TOAST;
import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_WRAITE;
import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_WRAITE_FILE;
import static com.hec.bluetooth.Activity.MainActivity.BLUE_TOOTH_WRAITE_FILE_NOW;
...
import com.hec.bluetooth.Adapter.RecyclerChatAdapter;
import com.hec.bluetooth.Bean.ChatInfo;
import com.hec.bluetooth.Bean.ChatRecord;
import com.hec.bluetooth.R;
import com.hec.bluetooth.SQLite.DBManager;
import com.hec.bluetooth.Service.BluetoothChatService;
import com.hec.bluetooth.Util.FileUtils;
import com.hec.bluetooth.Util.XPermissionUtil;
...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BLUE_TOOTH_READ:
                    ...
                    Log.i("hec chat", deviceName + ":" + readMessage);
                ...
                case BLUE_TOOTH_WRAITE:
                    ...
                    Log.i("hec chat", "Me" + ":" + writeMessage);
                ...
                case BLUE_TOOTH_READ_FILE_NOW:
                    Log.i("hec Bluetooth file transfer", msg.obj + "");
                    Snackbar.make(et_write, (String) msg.obj, Snackbar.LENGTH_LONG).show();
                    break;
                ...
                case BLUE_TOOTH_READ_FILE:
                    Log.i("hec Bluetooth file transfer", "File reception completed(" + msg.obj + ")");
                ...
                case BLUE_TOOTH_WRAITE_FILE:
                    Log.i("hec Bluetooth file transfer", "File sending completed");
                    dialog.dismiss();
    ...
    private void send() {
        String write = et_write.getText().toString().trim();
        if (TextUtils.isEmpty(write)) {
            Snackbar.make(et_write, "Sending content cannot be empty", Snackbar.LENGTH_LONG).show();
            return;
        }
        ...
        XPermissionUtil.requestPermissions(this, 1,
                ...
                new XPermissionUtil.OnPermissionListener() {
                    ...
                    public void onPermissionDenied() {
                        //权限获取失败
                        Snackbar.make(et_write, "Please manually go to the settings to give relevant permissions", Snackbar.LENGTH_LONG).show();
                    }
                });
    }
        ...
        switch (requestCode) {
            case FILE_SELECT_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    Log.i("hec-Select the file", "File Path: " + path);
                    if (path != null) {
                        ...
                        ad.setMessage("Are you sure you want to send this" + path + "Do you want to send?");
                        ad.setTitle("hint");
